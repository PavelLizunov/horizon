...
_TERA_PRONUNCIATIONS: Sequence[Tuple[str, str]] = (
    ...
    ("Dynamic Resource Allocation", "Дайнэмик Ресурс Аллокейшн"),
    ("Argonne National Laboratory", "Аргонн Нэшнл Лэборатори"),
    ("Open Shortest Path First", "Оупен Шортест Пас Фёрст"),
    ("google-deepmind/weathernext", "Гугл Дипмайнд слэш Уэзер Некст"),
    ("NetworkChuck Academy", "Нетворк Чак Академи"),
    ("Reasoning/Max Effort", "Ризонинг слэш Макс Эфорт"),
    ("The New York Times", "Зэ Нью-Йорк Таймс"),
    ("GraphCast/GenCast", "Графкаст слэш Дженкаст"),
    ("Steering Committee", "Стиринг Комити"),
    ("Trajectory Labs", "Трэджектори Лэбс"),
    ("Raccoon Heist", "Рэкун Хайст"),
    ("Terminal Bench", "Терминал Бенч"),
    ("NetworkChuck", "Нетворк Чак"),
    ("Sound Blaster", "Саунд Бластер"),
    ("The Register", "Зэ Реджистер"),
    ("OpenCode Go", "Оупен Код Гоу"),
    ("Oh My Pi", "Оу Май Пай"),
    ("Help Center", "Хелп Сентер"),
    ("think harder", "синк хардер"),
    ("prompt injection", "промпт инджекшн"),
    ("policy-as-code", "полиси эз код"),
    ("cloud-native", "клауд нейтив"),
    ("pre-commit", "пре-коммит"),
    ("feature gate", "фича гейт"),
    ("ResourceClaims", "Ресурс Клеймс"),
    ("ResourceClaim", "Ресурс Клейм"),
    ("ResourceSlice", "Ресурс Слайс"),
    ("ServiceAccount", "Сервис Аккаунт"),
    ("DeviceClass", "Девайс Класс"),
    ("libvgpu.so", "либ ви-джи-пи-ю эс-оу"),
    ("nvidia.com/gpu", "энвидиа точка ком слэш джи-пи-ю"),
    ("Fall Comdex", "Фол Комдекс"),
    ("Visi On", "Визи Он"),
    ("HAMi-core", "Хэми кор"),
    ("klepton-ld", "Клептон эл-ди"),
    ("Android/Quest", "Андроид слэш Квест"),
    ("docker/kubernetes", "Докер слэш Кубернетес"),
    ("DeepSWE", "Дип эс-дабл-ю-и"),
    ("WeatherNext", "Уэзер Некст"),
    ("OpenJDK", "Оупен джей-ди-кей"),
    ("ClickHouse", "Кликхаус"),
    ("ClickPipes", "Кликпайпс"),
    ("GoldenGate", "Голденгейт"),
    ("Artifactory", "Артифактори"),
    ("DeepMind", "Дипмайнд"),
    ("Databricks", "Датабрикс"),
    ("Accenture", "Эксенчер"),
    ("GraphCast", "Графкаст"),
    ("GenCast", "Дженкаст"),
    ("DeepSeek", "Дипсик"),
    ("Nixpkgs", "Никс пэкэджес"),
    ("NixOS", "Никс оу-эс"),
    ("Slashdot", "Слэшдот"),
    ("Blackwell", "Блэквелл"),
    ("Markdown", "Маркдаун"),
    ...
    ("VisiCorp", "Визикорп"),
    ("Macintosh", "Макинтош"),
    ("Minesweeper", "Майнсвипер"),
    ("Toastytech", "Тоусти Тек"),
    ("Snowflake", "Сноуфлейк"),
    ("microVM", "микро ви-эм"),
    ("PeerDB", "Пир ди-би"),
    ("SQLite", "эс-кью-эл-лайт"),
    ("Zstandard", "зи-стандарт"),
    ("iPadOS", "айпэд оу-эс"),
    ("visionOS", "вижн оу-эс"),
    ("macOS", "мак оу-эс"),
    ("coreutils", "кор ютилс"),
    ("gpumem", "джи-пи-ю мем"),
    ("gpucores", "джи-пи-ю корс"),
    ("Gitsign", "Гитсайн"),
    ("gitleaks", "Гитликс"),
    ("pytest", "пайтест"),
    ("uvx", "ю-ви-икс"),
    ...
    ("джи-пи-ти-4o-mini", "джипити четыре-оу мини"),
    ("gpt-4o-mini", "джипити четыре-оу мини"),
    ("gpt-image-2", "джипити имидж два"),
    ...
    ("джи-пи-ти-4o", "джипити четыре-оу"),
    ("джи-пи-ти", "джипити"),
    ("эн-эй-эс-эй", "наса"),
