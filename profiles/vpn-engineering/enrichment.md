...
Use a short factual title without marketing language. Do not turn release notes into a tutorial. Do not add verification labels: the Evidence Ledger publishes source coverage separately. Never claim a tool bypasses a censor unless the supplied evidence establishes where, when, and under what network conditions.
