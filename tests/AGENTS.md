...
| Component | Source Path | Representative Test Files (`tests/`) |
|---|---|---|
| **Scrapers & Ingestion** | `src/scrapers/`, `src/extractors/` | `test_fourpda.py`, `test_video.py`, `test_rss.py`, `test_reddit.py`, `test_twitter.py`, `test_gdelt.py`, `test_google_news.py`, `test_openbb_scraper.py`, `test_extractors_registry.py`, `test_extractors_trafilatura.py`, `test_fetch_reporting.py` |
...
| **Processing, Storage & Search** | `src/processing/`, `src/storage/`, `src/services/search.py`, `deploy/search/search_api.py`, `src/url_security.py` | `test_profiles.py`, `test_category_thresholds.py`, `test_category_wiring.py`, `test_cross_source_duplicates.py`, `test_content_selection.py`, `test_balanced_digest.py`, `test_search.py`, `test_search_api.py`, `test_storage.py`, `test_url_security.py` |
...
| **CLI & Orchestrator** | `src/_cli.py`, `src/main.py`, `src/orchestrator.py`, `src/setup/`, `deploy/` | `test_main.py`, `test_cli.py`, `test_branding.py`, `test_console_icons.py`, `test_collection_status.py`, `test_daily_deploy.py`, `test_logging_config.py`, `test_setup_wizard.py` |
