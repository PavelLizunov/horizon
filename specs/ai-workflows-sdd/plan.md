...
2. **Threshold Evaluation**: `src/orchestrator.py:passes_profile_filter()` checks `category_thresholds` dictionary before comparing against default profile threshold.
